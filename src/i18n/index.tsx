...
const en = {
  ...
  'home.shiftTooLongTitle': 'On duty over 15 hours', 'home.shiftTooLongBody': 'If your shift is over, please clock out now. A shift is not meant to run this long.',
  ...
  /* ------------------------------------------------------------------ *
   * BATCH 6c (2026-08-29) — the More menu + the sibling module-scope label tables (prospect
   * stages, notice-board categories, notify priorities/audiences). TRANSLATED BY CLAUDE, NOT
   * BY THE OWNER, under the same 2026-08-27 waiver as the 6f/6d/6e block above — read that
   * note. PROVISIONAL; a native reader should review. Each table is translated as a WHOLE
   * unit (a menu half in one language reads worse than all-English), per
   * docs/i18n/COPY-REQUEST-2026-08-26.md §6c. Six More rows reuse existing keys whose English
   * matches EXACTLY (Clients→tab.clients, Claims→tab.claims, Tickets→common.tickets,
   * Calendar→act.calendar, Contests→act.contests, Settings→settings.title); prospect
   * Meeting/Lost reuse stage.meeting/stage.lost. Nothing here rewords any English.
   * ------------------------------------------------------------------ */
  // The More menu (MORE_CATALOGUE) — the 16 titles that have no exact existing key.
  'more.leadsTitle': 'Leads and pipeline',
  'more.segmentsTitle': 'Segments',
  'more.familiesTitle': 'Families',
  'more.premiumTitle': 'Premium and greetings',
  'more.prospectsTitle': 'Prospects',
  'more.licTitle': 'LIC plans',
  'more.remindersTitle': 'Reminders and follow-ups',
  'more.attendanceTitle': 'My attendance',
  'more.whatsappTitle': 'WhatsApp Hub',
  'more.commissionsTitle': 'Commissions',
  'more.noticeTitle': 'Notice Board',
  'more.notesTitle': 'Notes',
  'more.kbTitle': 'Knowledge Base',
  'more.searchTitle': 'Global search',
  'more.profileTitle': 'My profile',
  'more.accountTitle': 'Account and privacy',
  // The More menu — the 21 one-word subtitles (profile has none).
  'more.leadsSub': 'Stages',
  'more.clientsSub': 'Directory',
  'more.segmentsSub': 'Smart lists',
  'more.familiesSub': 'Households',
  'more.premiumSub': 'Renewals',
  'more.prospectsSub': 'Recruitment',
  'more.licSub': 'Products',
  'more.claimsSub': 'Register',
  'more.ticketsSub': 'Requests',
  'more.remindersSub': 'Due dates',
  'more.calendarSub': 'Meetings',
  'more.attendanceSub': 'GPS log',
  'more.whatsappSub': 'Chats',
  'more.commissionsSub': 'Earnings',
  'more.noticeSub': 'From the firm',
  'more.notesSub': 'Private',
  'more.kbSub': 'Field guide',
  'more.searchSub': 'Everything',
  'more.contestsSub': 'Leaderboards',
  'more.settingsSub': 'Security, language',
  'more.accountSub': 'Data and deletion',
  // The Tickets row's dynamic hint when the live open count is known.
  'more.openCount': '{count} open',
  // The More content-group section headings (DEFAULT_UI.nav.more_sections; the "More" catch-all reuses tab.more).
  'more.groupBook': 'The book',
  'more.groupDayToDay': 'Day to day',
  'more.groupBoard': 'Board',
  'more.groupReference': 'Reference',
  'more.groupYou': 'You',
  // Prospect pipeline stages (prospects.tsx STAGE_META); Meeting/Lost reuse stage.*.
  'prospect.stageNotContacted': 'Not contacted',
  'prospect.stageProspect': 'Prospect',
  'prospect.stageTarget': 'Target',
  'prospect.stageContacted': 'Contacted',
  'prospect.stageResponded': 'Responded',
  'prospect.stageLead': 'Lead',
  'prospect.stageQuotation': 'Quotation',
  'prospect.stageDocuments': 'Documents',
  'prospect.stageLogin': 'Policy login',
  'prospect.stageWon': 'Won',
  'prospect.stageHold': 'Hold',
  // Notice-board categories (notice-board.tsx CATEGORY) — chip label + section heading.
  'notice.eventLabel': 'Event',
  'notice.eventGroup': 'Events',
  'notice.meetingLabel': 'Meeting',
  'notice.meetingGroup': 'Meetings',
  'notice.announcementLabel': 'Announcement',
  'notice.announcementGroup': 'Announcements',
  'notice.policyLabel': 'Policy',
  'notice.policyGroup': 'Policy updates',
  'notice.holidayLabel': 'Holiday',
  'notice.holidayGroup': 'Holidays',
  // Notify priorities + audiences (notify.tsx). Normal/Urgent are NOT the task Medium/High words.
  'notify.prioLow': 'Low',
  'notify.prioNormal': 'Normal',
  ...
  'voice.textOnly': 'This server replies as text — no voice back yet.',
...
const gu: Dict = {
  ...
  'home.shiftTooLongTitle': '15 કલાકથી વધુ સમયથી ડ્યુટી પર', 'home.shiftTooLongBody': 'જો તમારી શિફ્ટ પૂરી થઈ ગઈ હોય, તો કૃપા કરીને હમણાં ક્લોક-આઉટ કરો. શિફ્ટ આટલી લાંબી ચાલવી જોઈએ નહીં.',
  ...
  // Batch 6c (2026-08-29) — CLAUDE-TRANSLATED, owner-authorised. Provisional; see the English block.
  'more.leadsTitle': 'લીડ્સ અને પાઇપલાઇન',
  'more.segmentsTitle': 'સેગમેન્ટ્સ',
  'more.familiesTitle': 'પરિવારો',
  'more.premiumTitle': 'પ્રીમિયમ અને શુભેચ્છા',
  'more.prospectsTitle': 'પ્રોસ્પેક્ટ્સ',
  'more.licTitle': 'LIC પ્લાન',
  'more.remindersTitle': 'રિમાઇન્ડર્સ અને ફોલો-અપ્સ',
  'more.attendanceTitle': 'મારી હાજરી',
  'more.whatsappTitle': 'WhatsApp હબ',
  'more.commissionsTitle': 'કમિશન',
  'more.noticeTitle': 'નોટિસ બોર્ડ',
  'more.notesTitle': 'નોંધ',
  'more.kbTitle': 'નૉલેજ બેઝ',
  'more.searchTitle': 'ગ્લોબલ શોધ',
  'more.profileTitle': 'મારી પ્રોફાઇલ',
  'more.accountTitle': 'એકાઉન્ટ અને ગોપનીયતા',
  'more.leadsSub': 'સ્ટેજ',
  'more.clientsSub': 'ડિરેક્ટરી',
  'more.segmentsSub': 'સ્માર્ટ યાદીઓ',
  'more.familiesSub': 'કુટુંબ જૂથ',
  'more.premiumSub': 'રિન્યુઅલ્સ',
  'more.prospectsSub': 'ભરતી',
  'more.licSub': 'પ્રોડક્ટ્સ',
  'more.claimsSub': 'રજિસ્ટર',
  'more.ticketsSub': 'વિનંતીઓ',
  'more.remindersSub': 'નિયત તારીખો',
  'more.calendarSub': 'મીટિંગ્સ',
  'more.attendanceSub': 'GPS લોગ',
  'more.whatsappSub': 'ચેટ્સ',
  'more.commissionsSub': 'કમાણી',
  'more.noticeSub': 'કંપની તરફથી',
  'more.notesSub': 'ખાનગી',
  'more.kbSub': 'ફિલ્ડ ગાઇડ',
  'more.searchSub': 'બધું',
  'more.contestsSub': 'લીડરબોર્ડ',
  'more.settingsSub': 'સુરક્ષા, ભાષા',
  'more.accountSub': 'ડેટા અને ડિલીટ',
  'more.openCount': '{count} ઓપન',
  'more.groupBook': 'ક્લાયન્ટ બુક',
  'more.groupDayToDay': 'રોજિંદું કામ',
  'more.groupBoard': 'બોર્ડ',
  'more.groupReference': 'સંદર્ભ',
  'more.groupYou': 'તમે',
  'prospect.stageNotContacted': 'સંપર્ક કર્યો નથી',
  'prospect.stageProspect': 'પ્રોસ્પેક્ટ',
  'prospect.stageTarget': 'ટાર્ગેટ',
  'prospect.stageContacted': 'સંપર્ક કર્યો',
  'prospect.stageResponded': 'જવાબ મળ્યો',
  'prospect.stageLead': 'લીડ',
  'prospect.stageQuotation': 'ક્વોટેશન',
  'prospect.stageDocuments': 'દસ્તાવેજો',
  'prospect.stageLogin': 'પોલિસી લોગિન',
  'prospect.stageWon': 'જીત્યું',
  'prospect.stageHold': 'હોલ્ડ',
  'notice.eventLabel': 'ઇવેન્ટ',
  'notice.eventGroup': 'ઇવેન્ટ્સ',
  'notice.meetingLabel': 'મીટિંગ',
  'notice.meetingGroup': 'મીટિંગ્સ',
  'notice.announcementLabel': 'જાહેરાત',
  'notice.announcementGroup': 'જાહેરાતો',
  'notice.policyLabel': 'પોલિસી',
  'notice.policyGroup': 'પોલિસી અપડેટ્સ',
  'notice.holidayLabel': 'રજા',
  'notice.holidayGroup': 'રજાઓ',
  'notify.prioLow': 'ઓછી',
  'notify.prioNormal': 'સામાન્ય',
...
const hi: Dict = {
  ...
  'home.shiftTooLongTitle': '15 घंटे से ज़्यादा से ड्यूटी पर', 'home.shiftTooLongBody': 'अगर आपकी शिफ्ट खत्म हो गई है, तो कृपया अभी क्लॉक-आउट करें। शिफ्ट इतनी लंबी नहीं चलनी चाहिए।',
  ...
  // Batch 6c (2026-08-29) — CLAUDE-TRANSLATED, owner-authorised. Provisional; see the English block.
  'more.leadsTitle': 'लीड्स और पाइपलाइन',
  'more.segmentsTitle': 'सेगमेंट',
  'more.familiesTitle': 'परिवार',
  'more.premiumTitle': 'प्रीमियम और शुभकामनाएँ',
  'more.prospectsTitle': 'प्रॉस्पेक्ट्स',
  'more.licTitle': 'LIC प्लान',
  'more.remindersTitle': 'रिमाइंडर और फ़ॉलो-अप',
  'more.attendanceTitle': 'मेरी हाज़िरी',
  'more.whatsappTitle': 'WhatsApp हब',
  'more.commissionsTitle': 'कमीशन',
  'more.noticeTitle': 'नोटिस बोर्ड',
  'more.notesTitle': 'नोट्स',
  'more.kbTitle': 'नॉलेज बेस',
  'more.searchTitle': 'ग्लोबल खोज',
  'more.profileTitle': 'मेरी प्रोफ़ाइल',
  'more.accountTitle': 'अकाउंट और गोपनीयता',
  'more.leadsSub': 'स्टेज',
  'more.clientsSub': 'डायरेक्ट्री',
  'more.segmentsSub': 'स्मार्ट सूचियाँ',
  'more.familiesSub': 'परिवार समूह',
  'more.premiumSub': 'रिन्यूअल',
  'more.prospectsSub': 'भर्ती',
  'more.licSub': 'प्रोडक्ट',
  'more.claimsSub': 'रजिस्टर',
  'more.ticketsSub': 'अनुरोध',
  'more.remindersSub': 'देय तारीखें',
  'more.calendarSub': 'मीटिंग',
  'more.attendanceSub': 'GPS लॉग',
  'more.whatsappSub': 'चैट',
  'more.commissionsSub': 'कमाई',
  'more.noticeSub': 'कंपनी की ओर से',
  'more.notesSub': 'निजी',
  'more.kbSub': 'फ़ील्ड गाइड',
  'more.searchSub': 'सब कुछ',
  'more.contestsSub': 'लीडरबोर्ड',
  'more.settingsSub': 'सुरक्षा, भाषा',
  'more.accountSub': 'डेटा और डिलीट',
  'more.openCount': '{count} ओपन',
  'more.groupBook': 'क्लाइंट बुक',
  'more.groupDayToDay': 'रोज़ का काम',
  'more.groupBoard': 'बोर्ड',
  'more.groupReference': 'संदर्भ',
  'more.groupYou': 'आप',
  'prospect.stageNotContacted': 'संपर्क नहीं किया',
  'prospect.stageProspect': 'प्रॉस्पेक्ट',
  'prospect.stageTarget': 'टारगेट',
  'prospect.stageContacted': 'संपर्क किया',
  'prospect.stageResponded': 'जवाब मिला',
  'prospect.stageLead': 'लीड',
  'prospect.stageQuotation': 'कोटेशन',
  'prospect.stageDocuments': 'दस्तावेज़',
  'prospect.stageLogin': 'पॉलिसी लॉगिन',
  'prospect.stageWon': 'जीता',
  'prospect.stageHold': 'होल्ड',
  'notice.eventLabel': 'इवेंट',
  'notice.eventGroup': 'इवेंट',
  'notice.meetingLabel': 'मीटिंग',
  'notice.meetingGroup': 'मीटिंग',
  'notice.announcementLabel': 'घोषणा',
  'notice.announcementGroup': 'घोषणाएँ',
  'notice.policyLabel': 'पॉलिसी',
  'notice.policyGroup': 'पॉलिसी अपडेट',
  'notice.holidayLabel': 'छुट्टी',
  'notice.holidayGroup': 'छुट्टियाँ',
  'notify.prioLow': 'कम',
  'notify.prioNormal': 'सामान्य',
...
const hiEn: Dict = {
  ...
  'home.shiftTooLongTitle': '15 ghante se zyada se duty par', 'home.shiftTooLongBody': 'Agar aapki shift khatam ho gayi hai, toh please abhi clock-out karein. Shift itni lambi nahi chalni chahiye.',
  ...
  // Batch 6c (2026-08-29) — CLAUDE-TRANSLATED, owner-authorised. Provisional; see the English block.
  // Where a value is the plain English word, that is the trade-vocabulary fallback, not a miss.
  'more.leadsTitle': 'Leads aur pipeline',
  'more.segmentsTitle': 'Segments',
  'more.familiesTitle': 'Families',
  'more.premiumTitle': 'Premium aur shubhkamnaein',
  'more.prospectsTitle': 'Prospects',
  'more.licTitle': 'LIC plans',
  'more.remindersTitle': 'Reminders aur follow-ups',
  'more.attendanceTitle': 'Meri haazri',
  'more.whatsappTitle': 'WhatsApp Hub',
  'more.commissionsTitle': 'Commission',
  'more.noticeTitle': 'Notice Board',
  'more.notesTitle': 'Notes',
  'more.kbTitle': 'Knowledge Base',
  'more.searchTitle': 'Global search',
  'more.profileTitle': 'Meri profile',
  'more.accountTitle': 'Account aur privacy',
  'more.leadsSub': 'Stages',
  'more.clientsSub': 'Directory',
  'more.segmentsSub': 'Smart lists',
  'more.familiesSub': 'Households',
  ...
  'more.attendanceSub': 'GPS log',
  'more.whatsappSub': 'Chats',
  'more.commissionsSub': 'Kamai',
  'more.noticeSub': 'Company ki taraf se',
  'more.notesSub': 'Private',
  'more.kbSub': 'Field guide',
  'more.searchSub': 'Sab kuch',
  'more.contestsSub': 'Leaderboards',
  'more.settingsSub': 'Security, bhasha',
  'more.accountSub': 'Data aur deletion',
  'more.openCount': '{count} open',
  'more.groupBook': 'Client book',
  'more.groupDayToDay': 'Roz ka kaam',
  'more.groupBoard': 'Board',
  'more.groupReference': 'Reference',
  'more.groupYou': 'Aap',
  'prospect.stageNotContacted': 'Contact nahi kiya',
  'prospect.stageProspect': 'Prospect',
  'prospect.stageTarget': 'Target',
  'prospect.stageContacted': 'Contact kiya',
  'prospect.stageResponded': 'Jawab mila',
  'prospect.stageLead': 'Lead',
  'prospect.stageQuotation': 'Quotation',
  'prospect.stageDocuments': 'Documents',
  'prospect.stageLogin': 'Policy login',
  'prospect.stageWon': 'Jeeta',
  'prospect.stageHold': 'Hold',
  'notice.eventLabel': 'Event',
  'notice.eventGroup': 'Events',
  'notice.meetingLabel': 'Meeting',
...
const guEn: Dict = {
  ...
  'home.shiftTooLongTitle': '15 kalak thi vadhu samay thi duty par', 'home.shiftTooLongBody': 'Jo tamari shift puri thai gai hoy, to please have clock-out karo. Shift atli lambi chalvi na joiye.',
  ...
  // Batch 6c (2026-08-29) — CLAUDE-TRANSLATED, owner-authorised. Provisional; see the English block.
  // Where a value is the plain English word, that is the trade-vocabulary fallback, not a miss.
  'more.leadsTitle': 'Leads ane pipeline',
  'more.segmentsTitle': 'Segments',
  'more.familiesTitle': 'Families',
  'more.premiumTitle': 'Premium ane shubhechha',
  'more.prospectsTitle': 'Prospects',
  'more.licTitle': 'LIC plans',
  'more.remindersTitle': 'Reminders ane follow-ups',
  'more.attendanceTitle': 'Mari hajari',
  'more.whatsappTitle': 'WhatsApp Hub',
  'more.commissionsTitle': 'Commission',
  'more.noticeTitle': 'Notice Board',
  'more.notesTitle': 'Notes',
  'more.kbTitle': 'Knowledge Base',
  'more.searchTitle': 'Global search',
  'more.profileTitle': 'Mari profile',
  'more.accountTitle': 'Account ane privacy',
  'more.leadsSub': 'Stages',
  'more.clientsSub': 'Directory',
  'more.segmentsSub': 'Smart lists',
  'more.familiesSub': 'Households',
  ...
  'more.attendanceSub': 'GPS log',
  'more.whatsappSub': 'Chats',
  'more.commissionsSub': 'Kamani',
  'more.noticeSub': 'Company taraf thi',
  'more.notesSub': 'Private',
  'more.kbSub': 'Field guide',
  'more.searchSub': 'Badhu',
  'more.contestsSub': 'Leaderboards',
  'more.settingsSub': 'Suraksha, bhasha',
  'more.accountSub': 'Data ane deletion',
  'more.openCount': '{count} open',
  'more.groupBook': 'Client book',
  'more.groupDayToDay': 'Roj nu kaam',
  'more.groupBoard': 'Board',
  'more.groupReference': 'Reference',
  'more.groupYou': 'Tame',
  'prospect.stageNotContacted': 'Contact nathi karyo',
  'prospect.stageProspect': 'Prospect',
  'prospect.stageTarget': 'Target',
  'prospect.stageContacted': 'Contact karyo',
  'prospect.stageResponded': 'Jawab malyo',
  'prospect.stageLead': 'Lead',
  'prospect.stageQuotation': 'Quotation',
  'prospect.stageDocuments': 'Documents',
  'prospect.stageLogin': 'Policy login',
  'prospect.stageWon': 'Jityu',
  'prospect.stageHold': 'Hold',
  'notice.eventLabel': 'Event',
  'notice.eventGroup': 'Events',
  'notice.meetingLabel': 'Meeting',
  ...
  'notice.policyLabel': 'Policy',
  'notice.policyGroup': 'Policy updates',
  'notice.holidayLabel': 'Raja',
  'notice.holidayGroup': 'Rajao',
  'notify.prioLow': 'Low',
  'notify.prioNormal': 'Normal',
  'notify.prioUrgent': 'Urgent',

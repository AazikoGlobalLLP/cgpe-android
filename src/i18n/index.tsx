...
const en = {
  ...
  // Phase 100: generated copy authorized by the owner for the pending scope, 2026-09-07.
  'account.deletionUnavailable': "Account deletion requests are not available on this server yet.",
  'account.deletionReadForbidden': "This account cannot view deletion requests. Please contact your administrator.",
  'account.deletionRefreshFailed': "Could not refresh your request status. Please try again.",
  'account.deletionConfirmTitle': "Request account deletion?",
  'account.deletionConfirmBody': "This submits a request for review. It does not delete your account or its data, and you will stay signed in.",
  'account.deletionSubmit': "Submit request",
  'account.deletionSubmitForbidden': "This account cannot submit a deletion request. Please contact your administrator.",
  'account.deletionSubmitFailed': "Your request could not be confirmed. Refresh its status before trying again.",
  'account.deletionPending': "Pending review",
  'account.deletionRejected': "Request rejected",
  'account.deletionEyebrow': "Account deletion request",
  'account.deletionTitle': "Request account deletion",
  'account.deletionDescription': "Submit a request for review. Your account and data remain active; submitting a request does not erase them or sign you out.",
  'account.deletionStatusUnconfirmed': "Request status not confirmed",
  'account.deletionLastKnown': "Last known status: {statusLabel}",
  'account.deletionRejectedBody': "This request was rejected. Your account has not been deleted. Please contact your administrator about next steps.",
  'account.deletionRecordedBody': "Your request is recorded for review. Your account has not been deleted.",
  'account.deletionAction': "Request deletion",
  'account.privacyOpenFailed': "Could not open the browser. The policy is at cgpe.in/privacy.",
  'account.exportReady': "Your data export is ready — opening the download.",
  'account.exportOpenFailed': "Could not open the download link. Please try again.",
  'account.exportUnavailable': "Data export is not switched on for this server yet. Please try again later.",
  'account.exportFailed': "Could not create your data export right now. Please try again.",
  'account.signedOut': "You are signed out",
  'account.signedOutBody': "Sign in to export your data or request account deletion for review.",
  'account.dataProtected': "Your data is protected",
  'account.dataProtectionBody': "Encrypted in transit. We follow India's DPDP Act for personal and policy data.",
  'account.yourData': "Your data",
  'account.exportDescription': "A copy of your own records, downloaded to this phone as a spreadsheet.",
...
const gu: Dict = {
  ...
  'voice.notSetUp': "આ સર્વર પર વૉઇસની સુવિધા હજી ચાલુ નથી. તેને ચાલુ કરવા તમારા એડમિનને કહો.",
  'voice.textOnly': "આ સર્વર લખીને જવાબ આપે છે — હજી અવાજમાં જવાબ મળતો નથી.",
  'voice.stillWorking': "હજી કામ ચાલી રહ્યું છે…",
  'voice.whichOne': 'કઈ?',
  'voice.female': 'સ્ત્રી',
  'voice.male': 'પુરુષ',
  // NOT machine-translated: English in all five, on purpose. New surface (the over-the-air
  // update banner), no owner copy yet — the `tab.search`/`voice.*` precedent. Requested as Batch 6i.
  'update.ready': "અપડેટ તૈયાર છે",
  'update.restart': "હમણાં ફરી શરૂ કરો",

  // Phase 100: generated copy authorized by the owner for the pending scope, 2026-09-07.
  'account.deletionUnavailable': "આ સર્વર પર એકાઉન્ટ કાઢી નાખવાની વિનંતીની સુવિધા હજી ઉપલબ્ધ નથી.",
  'account.deletionReadForbidden': "આ એકાઉન્ટથી એકાઉન્ટ કાઢી નાખવાની વિનંતીઓ જોઈ શકાતી નથી. કૃપા કરીને તમારા એડમિનનો સંપર્ક કરો.",
  'account.deletionRefreshFailed': "તમારી વિનંતીની હાલની સ્થિતિ જાણી શકાઈ નથી. કૃપા કરીને ફરી પ્રયાસ કરો.",
  'account.deletionConfirmTitle': "એકાઉન્ટ કાઢી નાખવાની વિનંતી કરવી છે?",
  'account.deletionConfirmBody': "આથી સમીક્ષા માટે વિનંતી મોકલાશે. તમારું એકાઉન્ટ કે તેનો ડેટા કાઢી નાખવામાં નહીં આવે અને તમે સાઇન ઇન રહેશો.",
  'account.deletionSubmit': "વિનંતી મોકલો",
  'account.deletionSubmitForbidden': "આ એકાઉન્ટથી એકાઉન્ટ કાઢી નાખવાની વિનંતી મોકલી શકાતી નથી. કૃપા કરીને તમારા એડમિનનો સંપર્ક કરો.",
  'account.deletionSubmitFailed': "તમારી વિનંતીની પુષ્ટિ થઈ શકી નથી. ફરી પ્રયાસ કરતાં પહેલાં તેની હાલની સ્થિતિ તપાસો.",
  'account.deletionPending': "સમીક્ષાની રાહમાં",
  'account.deletionRejected': "વિનંતી નકારાઈ",
  'account.deletionEyebrow': "એકાઉન્ટ કાઢી નાખવાની વિનંતી",
  'account.deletionTitle': "એકાઉન્ટ કાઢી નાખવાની વિનંતી કરો",
  'account.deletionDescription': "સમીક્ષા માટે વિનંતી મોકલો. તમારું એકાઉન્ટ અને ડેટા સક્રિય રહેશે; વિનંતી મોકલવાથી તે કાઢી નાખવામાં નહીં આવે કે તમે સાઇન આઉટ નહીં થાઓ.",
  'account.deletionStatusUnconfirmed': "વિનંતીની સ્થિતિની પુષ્ટિ થઈ નથી",
  'account.deletionLastKnown': "છેલ્લે મળેલી સ્થિતિ: {statusLabel}",
  'account.deletionRejectedBody': "આ વિનંતી નકારવામાં આવી છે. તમારું એકાઉન્ટ કાઢી નાખવામાં આવ્યું નથી. આગળ શું કરવું તે માટે કૃપા કરીને તમારા એડમિનનો સંપર્ક કરો.",
  'account.deletionRecordedBody': "તમારી વિનંતી સમીક્ષા માટે નોંધાઈ છે. તમારું એકાઉન્ટ કાઢી નાખવામાં આવ્યું નથી.",
  'account.deletionAction': "કાઢી નાખવાની વિનંતી કરો",
  'account.privacyOpenFailed': "બ્રાઉઝર ખોલી શકાયું નથી. ગોપનીયતા નીતિ cgpe.in/privacy પર છે.",
  'account.exportReady': "તમારો ડેટા એક્સપોર્ટ તૈયાર છે — ડાઉનલોડ ખોલી રહ્યા છીએ.",
  'account.exportOpenFailed': "ડાઉનલોડ લિંક ખોલી શકાઈ નથી. કૃપા કરીને ફરી પ્રયાસ કરો.",
  'account.exportUnavailable': "આ સર્વર પર ડેટા એક્સપોર્ટની સુવિધા હજી ચાલુ નથી. કૃપા કરીને પછી ફરી પ્રયાસ કરો.",
  'account.exportFailed': "અત્યારે તમારો ડેટા એક્સપોર્ટ તૈયાર થઈ શક્યો નથી. કૃપા કરીને ફરી પ્રયાસ કરો.",
  'account.signedOut': "તમે સાઇન આઉટ છો",
  'account.signedOutBody': "તમારો ડેટા એક્સપોર્ટ કરવા અથવા સમીક્ષા માટે એકાઉન્ટ કાઢી નાખવાની વિનંતી કરવા સાઇન ઇન કરો.",
  'account.dataProtected': "તમારો ડેટા સુરક્ષિત છે",
  'account.dataProtectionBody': "મોકલાતો ડેટા એન્ક્રિપ્ટેડ હોય છે. વ્યક્તિગત અને પોલિસીના ડેટા માટે અમે ભારતના DPDP કાયદાનું પાલન કરીએ છીએ.",
  'account.yourData': "તમારો ડેટા",
  'account.exportDescription': "તમારા પોતાના રેકોર્ડની નકલ, આ ફોનમાં સ્પ્રેડશીટ તરીકે ડાઉનલોડ થાય છે.",
  'account.export': "મારો ડેટા એક્સપોર્ટ કરો",
  'account.preparing': "તૈયાર થઈ રહ્યું છે…",
  'account.privacy': "ગોપનીયતા નીતિ",
};
...
const hi: Dict = {
  ...
  'voice.notSetUp': "इस सर्वर पर वॉइस की सुविधा अभी चालू नहीं है। अपने एडमिन से इसे चालू करने को कहें।",
  'voice.textOnly': "यह सर्वर लिखकर जवाब देता है — अभी आवाज़ में जवाब नहीं मिलता।",
  'voice.stillWorking': "अभी काम चल रहा है…",
  ...
  'update.restart': "अभी फिर शुरू करें",

  // Phase 100: generated copy authorized by the owner for the pending scope, 2026-09-07.
  'account.deletionUnavailable': "इस सर्वर पर अकाउंट हटाने का अनुरोध भेजने की सुविधा अभी उपलब्ध नहीं है।",
  'account.deletionReadForbidden': "इस अकाउंट से अकाउंट हटाने के अनुरोध नहीं देख सकते। कृपया अपने एडमिन से संपर्क करें।",
  'account.deletionRefreshFailed': "आपके अनुरोध की ताज़ा स्थिति नहीं मिल सकी। कृपया फिर कोशिश करें।",
  'account.deletionConfirmTitle': "अकाउंट हटाने का अनुरोध करें?",
  'account.deletionConfirmBody': "इससे समीक्षा के लिए अनुरोध भेजा जाएगा। आपका अकाउंट या उसका डेटा नहीं हटेगा और आप साइन इन रहेंगे।",
  'account.deletionSubmit': "अनुरोध भेजें",
  'account.deletionSubmitForbidden': "इस अकाउंट से अकाउंट हटाने का अनुरोध नहीं भेज सकते। कृपया अपने एडमिन से संपर्क करें।",
  'account.deletionSubmitFailed': "आपके अनुरोध की पुष्टि नहीं हो सकी। फिर कोशिश करने से पहले उसकी ताज़ा स्थिति देखें।",
  'account.deletionPending': "समीक्षा की प्रतीक्षा में",
  'account.deletionRejected': "अनुरोध अस्वीकार हुआ",
  'account.deletionEyebrow': "अकाउंट हटाने का अनुरोध",
  'account.deletionTitle': "अकाउंट हटाने का अनुरोध करें",
  'account.deletionDescription': "समीक्षा के लिए अनुरोध भेजें। आपका अकाउंट और डेटा सक्रिय रहेंगे; अनुरोध भेजने से वे मिटेंगे नहीं और आप साइन आउट नहीं होंगे।",
  'account.deletionStatusUnconfirmed': "अनुरोध की स्थिति की पुष्टि नहीं हुई",
  'account.deletionLastKnown': "आखिरी बार मिली स्थिति: {statusLabel}",
  'account.deletionRejectedBody': "यह अनुरोध अस्वीकार कर दिया गया है। आपका अकाउंट नहीं हटाया गया है। आगे क्या करना है, इसके लिए कृपया अपने एडमिन से संपर्क करें।",
  'account.deletionRecordedBody': "आपका अनुरोध समीक्षा के लिए दर्ज हो गया है। आपका अकाउंट नहीं हटाया गया है।",
  'account.deletionAction': "हटाने का अनुरोध करें",
  'account.privacyOpenFailed': "ब्राउज़र नहीं खुल सका। गोपनीयता नीति cgpe.in/privacy पर है।",
  'account.exportReady': "आपका डेटा एक्सपोर्ट तैयार है — डाउनलोड खोल रहे हैं।",
  'account.exportOpenFailed': "डाउनलोड लिंक नहीं खुल सका। कृपया फिर कोशिश करें।",
  'account.exportUnavailable': "इस सर्वर पर डेटा एक्सपोर्ट की सुविधा अभी चालू नहीं है। कृपया बाद में फिर कोशिश करें।",
  'account.exportFailed': "अभी आपका डेटा एक्सपोर्ट तैयार नहीं हो सका। कृपया फिर कोशिश करें।",
  'account.signedOut': "आप साइन आउट हैं",
  'account.signedOutBody': "अपना डेटा एक्सपोर्ट करने या समीक्षा के लिए अकाउंट हटाने का अनुरोध भेजने के लिए साइन इन करें।",
  'account.dataProtected': "आपका डेटा सुरक्षित है",
  'account.dataProtectionBody': "भेजते समय डेटा एन्क्रिप्टेड रहता है। व्यक्तिगत और पॉलिसी डेटा के लिए हम भारत के DPDP अधिनियम का पालन करते हैं।",
  'account.yourData': "आपका डेटा",
  'account.exportDescription': "आपके अपने रिकॉर्ड की एक कॉपी, जो इस फ़ोन में स्प्रेडशीट के रूप में डाउनलोड होती है।",
  'account.export': "मेरा डेटा एक्सपोर्ट करें",
  'account.preparing': "तैयार हो रहा है…",
  'account.privacy': "गोपनीयता नीति",
};
...
const hiEn: Dict = {
  ...
  'voice.notSetUp': "Is server par voice ki suvidha abhi chalu nahi hai. Apne admin se ise chalu karne ko kahein.",
  'voice.textOnly': "Yeh server likhkar jawab deta hai — abhi awaaz mein jawab nahi milta.",
  'voice.stillWorking': "Abhi kaam chal raha hai…",
  'voice.whichOne': 'Kaunsa?',
  'voice.female': 'Female',
  'voice.male': 'Male',
  // NOT machine-translated: English in all five, on purpose. New surface (the over-the-air
  // update banner), no owner copy yet — the `tab.search`/`voice.*` precedent. Requested as Batch 6i.
  'update.ready': "Update taiyar hai",
  'update.restart': "Abhi phir shuru karein",

  // Phase 100: generated copy authorized by the owner for the pending scope, 2026-09-07.
  'account.deletionUnavailable': "Is server par account hatane ki request ki suvidha abhi uplabdh nahi hai.",
  'account.deletionReadForbidden': "Is account se account hatane ki requests nahi dekh sakte. Kripya apne admin se sampark karein.",
  'account.deletionRefreshFailed': "Aapki request ka taaza status nahi mil saka. Kripya phir koshish karein.",
  'account.deletionConfirmTitle': "Account hatane ki request karein?",
  'account.deletionConfirmBody': "Isse review ke liye request bheji jayegi. Aapka account ya uska data nahi hatega aur aap sign in rahenge.",
  'account.deletionSubmit': "Request bhejein",
  'account.deletionSubmitForbidden': "Is account se account hatane ki request nahi bhej sakte. Kripya apne admin se sampark karein.",
  'account.deletionSubmitFailed': "Aapki request ki pushti nahi ho saki. Phir koshish karne se pehle uska taaza status dekhein.",
  'account.deletionPending': "Review ka intezar hai",
  'account.deletionRejected': "Request asweekar hui",
  'account.deletionEyebrow': "Account hatane ki request",
  'account.deletionTitle': "Account hatane ki request karein",
  'account.deletionDescription': "Review ke liye request bhejein. Aapka account aur data active rahenge; request bhejne se ve mitenge nahi aur aap sign out nahi honge.",
  'account.deletionStatusUnconfirmed': "Request ke status ki pushti nahi hui",
  'account.deletionLastKnown': "Aakhri baar mila status: {statusLabel}",
  'account.deletionRejectedBody': "Yeh request asweekar kar di gayi hai. Aapka account nahi hataya gaya hai. Aage kya karna hai, iske liye kripya apne admin se sampark karein.",
  'account.deletionRecordedBody': "Aapki request review ke liye darj ho gayi hai. Aapka account nahi hataya gaya hai.",
  'account.deletionAction': "Hatane ki request karein",
  'account.privacyOpenFailed': "Browser nahi khul saka. Privacy policy cgpe.in/privacy par hai.",
  'account.exportReady': "Aapka data export taiyar hai — download khol rahe hain.",
  'account.exportOpenFailed': "Download link nahi khul saka. Kripya phir koshish karein.",
  'account.exportUnavailable': "Is server par data export ki suvidha abhi chalu nahi hai. Kripya baad mein phir koshish karein.",
  'account.exportFailed': "Abhi aapka data export taiyar nahi ho saka. Kripya phir koshish karein.",
  'account.signedOut': "Aap sign out hain",
  'account.signedOutBody': "Apna data export karne ya review ke liye account hatane ki request bhejne ke liye sign in karein.",
  'account.dataProtected': "Aapka data surakshit hai",
  'account.dataProtectionBody': "Bhejte samay data encrypted rehta hai. Personal aur policy data ke liye hum Bharat ke DPDP Act ka palan karte hain.",
  'account.yourData': "Aapka data",
  'account.exportDescription': "Aapke apne records ki ek copy, jo is phone mein spreadsheet ke roop mein download hoti hai.",
  'account.export': "Mera data export karein",
  'account.preparing': "Taiyar ho raha hai…",
  'account.privacy': "Gopniyata ki policy",
};
...
const guEn: Dict = {
  ...
  'voice.notSetUp': "Aa server par voice ni suvidha haji chalu nathi. Tene chalu karva tamara admin ne kaho.",
  'voice.textOnly': "Aa server lakhine jawab aape chhe — haji awaaj ma jawab malto nathi.",
  'voice.stillWorking': "Haji kaam chali rahyu chhe…",
  'voice.whichOne': 'Kai?',
  'voice.female': 'Female',
  'voice.male': 'Male',
  // NOT machine-translated: English in all five, on purpose. New surface (the over-the-air
  // update banner), no owner copy yet — the `tab.search`/`voice.*` precedent. Requested as Batch 6i.
  'update.ready': "Update taiyar chhe",
  'update.restart': "Hamna fari sharu karo",

  // Phase 100: generated copy authorized by the owner for the pending scope, 2026-09-07.
  'account.deletionUnavailable': "Aa server par account kadhi nakhvani request ni suvidha haji uplabdh nathi.",
  'account.deletionReadForbidden': "Aa account thi account kadhi nakhvani requests joi shakati nathi. Krupa karine tamara admin no sampark karo.",
  'account.deletionRefreshFailed': "Tamari request no haal no status mali shakyo nathi. Krupa karine fari prayatna karo.",
  'account.deletionConfirmTitle': "Account kadhi nakhvani request karvi chhe?",
  'account.deletionConfirmBody': "Aathi review mate request moklashe. Tamaru account ke teno data kadhi nakhvama nahi aave ane tame sign in rahesho.",
  'account.deletionSubmit': "Request moklo",
  'account.deletionSubmitForbidden': "Aa account thi account kadhi nakhvani request mokli shakati nathi. Krupa karine tamara admin no sampark karo.",
  'account.deletionSubmitFailed': "Tamari request ni pushti thai shaki nathi. Fari prayatna karta pehla teno haal no status tapaso.",
  'account.deletionPending': "Review ni raah ma",
  'account.deletionRejected': "Request nakarai",
  'account.deletionEyebrow': "Account kadhi nakhvani request",
  'account.deletionTitle': "Account kadhi nakhvani request karo",
  'account.deletionDescription': "Review mate request moklo. Tamaru account ane data active raheshe; request moklavathi te kadhi nakhvama nahi aave ke tame sign out nahi thao.",
  'account.deletionStatusUnconfirmed': "Request na status ni pushti thai nathi",
  'account.deletionLastKnown': "Chhelle malelo status: {statusLabel}",
  'account.deletionRejectedBody': "Aa request nakarvama aavi chhe. Tamaru account kadhi nakhvama aavyu nathi. Aagal shu karvu te mate krupa karine tamara admin no sampark karo.",
  'account.deletionRecordedBody': "Tamari request review mate nondhai chhe. Tamaru account kadhi nakhvama aavyu nathi.",
  'account.deletionAction': "Kadhi nakhvani request karo",
  'account.privacyOpenFailed': "Browser kholi shakayu nathi. Privacy policy cgpe.in/privacy par chhe.",
  'account.exportReady': "Tamaro data export taiyar chhe — download kholi rahya chhiye.",
  'account.exportOpenFailed': "Download link kholi shakai nathi. Krupa karine fari prayatna karo.",
  'account.exportUnavailable': "Aa server par data export ni suvidha haji chalu nathi. Krupa karine pachhi fari prayatna karo.",
  'account.exportFailed': "Atyare tamaro data export taiyar thai shakyo nathi. Krupa karine fari prayatna karo.",
  'account.signedOut': "Tame sign out chho",
  'account.signedOutBody': "Tamaro data export karva athva review mate account kadhi nakhvani request karva sign in karo.",
  'account.dataProtected': "Tamaro data surakshit chhe",
  'account.dataProtectionBody': "Moklato data encrypted hoy chhe. Personal ane policy data mate ame Bharat na DPDP Act nu palan kariye chhiye.",
  'account.yourData': "Tamaro data",
  'account.exportDescription': "Tamara potana records ni copy, aa phone ma spreadsheet tarike download thay chhe.",
  'account.export': "Maro data export karo",
  'account.preparing': "Taiyar thai rahyu chhe…",
  'account.privacy': "Gopaniyata ni policy",
};
